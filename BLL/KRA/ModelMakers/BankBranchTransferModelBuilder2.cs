...
{
    public class BankBranchTransferModelBuilder2
    {
        ...
        public BankBranchTransferModelBuilder2(DAL.Employer _employer, bool current, int period, int year, string Conn)
        {
            try
            {
