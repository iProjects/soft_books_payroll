...
{
    public partial class payslip_master_form : Form
    {
        DataEntry de;
        ...
        public payslip_master_form(string user, string Conn, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            InitializeComponent();
            ...
            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("finished payslip_master_form initialization", TAG));
        }

        private void payslip_master_form_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("finished payslip_master_form load", TAG));
            }
            catch (Exception ex)
            {
        ...
        private void btnclearfilter_Click(object sender, EventArgs e)
        {
            try
            {
                var _payslips_query = from p in db.PayslipMaster_Temp
