...
{
    public class BankEmployeeExcelBuilder
    {
        //private attributes 
        BankEmployeesModelReport _emreportmodel;
        ...
        //constructor
        public BankEmployeeExcelBuilder(BankEmployeesModelReport emreportmodel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
        ...
        private void AddDocHeader(ref int row, ref int col)
        {
            ...
            row++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, "BANK EMPLOYEES REPORT", cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
        ...
        private void AddDocBody(ref int row, ref int col)
        {
            ...
            //Add table detail
            foreach (var d in _emreportmodel.pbe)
            {
        ...
        private void AddBodytableHeaders(ref int row, ref int col)
        {
            ...
            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, "ACCOUNT NAME", cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
        ...
        //table details
        private void AddBodyTableDetail(print_bank_employees paemp, ref int row, ref int col)
        {
            ...
            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, paemp.AccountName, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");

            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, paemp.AccountNo, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
