...
{
    public class CashEmployeeExcelBuilder
    {
        //private attributes 
        CashEmployeesModelReport _emreportmodel;
        ...
        //constructor
        public CashEmployeeExcelBuilder(CashEmployeesModelReport emreportmodel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
        ...
        private void AddDocBody(ref int row, ref int col)
        {
            ...
            //Add table detail
            foreach (var d in _emreportmodel.pce)
            {
        ...
        //table details
        private void AddBodyTableDetail(print_cash_employees paemp, ref int row, ref int col)
        {
