...
{
    public class MpesaEmployeeExcelBuilder
    {
        //private attributes 
        MpesaEmployeesModelReport _emreportmodel;
        ...
        //constructor
        public MpesaEmployeeExcelBuilder(MpesaEmployeesModelReport emreportmodel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
        ...
        private void AddDocHeader(ref int row, ref int col)
        {
            ...
            row++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, "MPESA EMPLOYEES REPORT", cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
        ...
        private void AddDocBody(ref int row, ref int col)
        {
            ...
            //Add table detail
            foreach (var d in _emreportmodel.pme)
            {
        ...
        //table details
        private void AddBodyTableDetail(print_mpesa_employees paemp, ref int row, ref int col)
        {
            ...
            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, paemp.phone_no, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
