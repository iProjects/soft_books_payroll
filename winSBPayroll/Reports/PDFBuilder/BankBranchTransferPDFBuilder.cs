...
namespace winSBPayroll.Reports.PDFBuilder
{
    public class BankBranchTransferPDFBuilder
    {
        ...
        //constructor
        public BankBranchTransferPDFBuilder(BankTransferModel bbtransfermodel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            ...
            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("Constructed BankBranchTransferPDFBuilder", TAG));
