...
{
    public class BankBranchTransferPDFBuilder3
    {
        ...
        //constructor
        public BankBranchTransferPDFBuilder3(BankTransferModel bbtransfermodel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            ...
            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("Constructed BankBranchTransferPDFBuilder3", TAG));
