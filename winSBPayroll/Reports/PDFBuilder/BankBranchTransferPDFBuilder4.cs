...
{
    public class BankBranchTransferPDFBuilder4
    {
        ...
        //constructor
        public BankBranchTransferPDFBuilder4(BankTransferModel bbtransfermodel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            ...
            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("Constructed BankBranchTransferPDFBuilder4", TAG));
