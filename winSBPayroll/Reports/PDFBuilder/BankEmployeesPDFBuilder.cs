...
{
    public class BankEmployeesPDFBuilder
    {
        Document document;
        string Message;
        string sFilePDF;
        ...
        public BankEmployeesPDFBuilder(BankEmployeesModelReport employeesModel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            if (employeesModel == null)
                throw new ArgumentNullException("BankEmployeesModelReport is null");
            _ViewModel = employeesModel;

            _notificationmessageEventname = notificationmessageEventname;

            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("Constructed BankEmployeesPDFBuilder", TAG));
        ...
        private void AddDocHeader()
        {
            ...
            Cell bCell = new Cell(new Phrase("BANK EMPLOYEES REPORT", hFont1));
        ...
        private void AddDocBody()
        {
            ...
            //Add table details  
            foreach (var d in _ViewModel.pbe)
            {
                AddTableDetails(d);
            }
        ...
        {
            Table employeesTable = new Table(10);
            employeesTable.WidthPercentage = 100;
            employeesTable.Padding = 1;
            employeesTable.Spacing = 1;
        ...
        //table details 
        private void AddTableDetails(print_bank_employees paemp)
        {
            Table employeesTable = new Table(10);
            employeesTable.WidthPercentage = 100;
            employeesTable.Padding = 1;
            ...
            Cell paymentmode = new Cell(new Phrase(paemp.AccountName, rms8Bold));
            paymentmode.Border = Cell.RECTANGLE;
            paymentmode.HorizontalAlignment = Cell.ALIGN_CENTER;
            employeesTable.AddCell(paymentmode);

            Cell accountno = new Cell(new Phrase(paemp.AccountNo, rms8Bold));
            accountno.Border = Cell.RECTANGLE;
            accountno.HorizontalAlignment = Cell.ALIGN_CENTER;
            employeesTable.AddCell(accountno);
