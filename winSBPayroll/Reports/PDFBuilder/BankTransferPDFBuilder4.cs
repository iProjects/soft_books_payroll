...
{
    public class BankTransferPDFBuilder4
    {
        ...
        //constructor
        public BankTransferPDFBuilder4(BankTransferReportModel bbtransfermodel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            ...
            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("Constructed BankTransferPDFBuilder4", TAG));
        ...
        private void AddDocHeader()
        {
            ...
            bankTransferTable.AddCell(salutation);
