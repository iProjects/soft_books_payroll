...
{
    public class CashEmployeesPDFBuilder
    {
        Document document;
        string Message;
        string sFilePDF;
        ...
        public CashEmployeesPDFBuilder(CashEmployeesModelReport employeesModel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            if (employeesModel == null)
                throw new ArgumentNullException("CashEmployeesModelReport is null");
        ...
        private void AddDocHeader()
        {
            ...
            Cell bCell = new Cell(new Phrase("CASH EMPLOYEES REPORT", hFont1));
        ...
        private void AddDocBody()
        {
            ...
            //Add table details  
            foreach (var d in _ViewModel.pce)
            {
                AddTableDetails(d);
            }
        ...
        //table details 
        private void AddTableDetails(print_cash_employees paemp)
        {
            Table employeesTable = new Table(9);
            employeesTable.WidthPercentage = 100;
            employeesTable.Padding = 1;
