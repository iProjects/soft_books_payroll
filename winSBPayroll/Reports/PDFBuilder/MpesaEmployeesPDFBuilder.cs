...
{
    public class MpesaEmployeesPDFBuilder
    {
        Document document;
        string Message;
        string sFilePDF;
        ...
        public MpesaEmployeesPDFBuilder(MpesaEmployeesModelReport employeesModel, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
            if (employeesModel == null)
                throw new ArgumentNullException("MpesaEmployeesModelReport is null");
            _ViewModel = employeesModel;

            _notificationmessageEventname = notificationmessageEventname;

            _notificationmessageEventname.Invoke(this, new notificationmessageEventArgs("Constructed MpesaEmployeesPDFBuilder", TAG));
        ...
        private void AddDocHeader()
        {
            ...
            Cell bCell = new Cell(new Phrase("MPESA EMPLOYEES REPORT", hFont1));
        ...
        private void AddDocBody()
        {
            ...
            //Add table details  
            foreach (var d in _ViewModel.pme)
            {
                AddTableDetails(d);
            }
        ...
        private void AddTableHeaders()
        {
            ...
            Cell paymentmode = new Cell(new Phrase("Phone no", tHFont));
        ...
        //table details 
        private void AddTableDetails(print_mpesa_employees paemp)
        {
            Table employeesTable = new Table(9);
            employeesTable.WidthPercentage = 100;
            employeesTable.Padding = 1;
            ...
            Cell paymentmode = new Cell(new Phrase(paemp.phone_no, rms8Bold));
            paymentmode.Border = Cell.RECTANGLE;
            paymentmode.HorizontalAlignment = Cell.ALIGN_CENTER;
            employeesTable.AddCell(paymentmode);
