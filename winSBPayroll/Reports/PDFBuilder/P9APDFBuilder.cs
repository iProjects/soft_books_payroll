...
{
    public class P9APDFBuilder
    {
        P9AReportModel _ViewModel;
        Document document;
        string Message;
        string sFilePDF;
        ...
        private void BuildPDF()
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= 12; i++)
                {
                    var monthRecs = (from mr in _ViewModel.P9AEmpList
                                     where mr.MonthInt == i
        ...
        private void AddTableHeaders(Table aTable)
        {
            ...
            aTable.AddCell(new Phrase("Owner Occupied Interest\nKshs", tHFont)); //Col 6
        ...
        private void AddFooter()
        {
            ...
            Cell f31 = new Cell("");
            f31.Border = Cell.NO_BORDER;
            aTable.AddCell(f31);
            Paragraph p1 = new Paragraph("(b) Attach  (i) Photostat copies of interest certificate and statetement for account from the Financial Instituation \n             (ii) The Declaration duly signed by the employee to form P9A.", rms8Normal);

            Cell f32 = new Cell(p1);
            f32.HorizontalAlignment = Cell.ALIGN_LEFT;
            f32.Border = Table.NO_BORDER;
            aTable.AddCell(f32);
            ...
            sb.AppendLine("(b) Where an employee is eligible to deduction on owner occupied interest");
            sb.AppendLine("2(a) Deductible interest in respect of any month must not exceed Kshs. 12,500/=");
            p2.Add(new Phrase(sb.ToString(), rms8Normal));

            StringBuilder sb1 = new StringBuilder();
            sb1.AppendLine();
            sb1.AppendLine("See back of this card for further information required by the Department");
            sb1.AppendLine("P.9A");
            ...
            sb3.AppendLine("NAMES OF FINANCIAL INSTITUTION ANDVANCING MORTGAGE LOAN");
            sb3.AppendLine("..............................................................................");
            sb3.AppendLine("L.R NO. OF OWNER OCCUPIED PROPERTY..................................");
            sb3.AppendLine("DATE OF OCCUPATION OF HOUSE .....................................");
